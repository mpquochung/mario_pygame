...
from tiles import  Tile, StaticTile, Crate, Palm , Coin
from support import import_cut_graphic, import_csv_layout
...
class Level:
    def __init__ (self, level_data, surface):
        ...
        self.clouds= Cloud(400,level_width,cloud_number=randint(20,30))
